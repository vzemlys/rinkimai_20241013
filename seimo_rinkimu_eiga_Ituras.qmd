...
ggplot(aes(x = lt_proc_rinkeju, y = proc_nuo_dal_rinkeju, group = santrumpa, colour = santrumpa), data = dtg1) +
    geom_point() +
    geom_line() +
    theme_bw() +
...
ggplot(aes(x = lt_proc_rinkeju , y = proc_nuo_dal_rinkeju, group = santrumpa, colour = santrumpa), data = dtg1 %>% filter(saraso_numeris %in% c(16,5, 2))) +
    geom_point() +
    geom_line() +
    theme_bw() +
